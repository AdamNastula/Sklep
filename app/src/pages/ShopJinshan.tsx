...
function ShopJinshan() {
  ...
  return (
    <>
      <div className="bg-main-color h-fit min-h-dvh mx-0 pt-32 overflow-clip">
        <NavBar setBasketOpen={setBasketOpen}></NavBar>
        <Basket
          isBasketOpen={isBasketOpen}
          setBasketOpen={setBasketOpen}
        ></Basket>
        <div className="max-w-[1200px] h-[400px] bg-black mx-auto"></div>
        <div className="max-w-[1000px] min-h-[300px] mx-auto mb-2">
          ...
          ></ControlBar>
          <div className="flex mt-20 flex-row flex-wrap justify-center min-h-[300px]">
            {query.isFetched &&
            ...
            {query.isLoading && <Spinner></Spinner>}

            {query.isError && (
              <h1 className="mx-auto text-xl">
                Nie udało się wczytać produktów. Prosimy spróbować później.
              </h1>
            )}
          </div>
